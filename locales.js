// locales.js — 10 языков, v0.40, без смайликов, добавлен updateBtn
const translations = {
  en: {
    ...
    realismLabel: "Realism mode",
    realismNote: "Only 50-70% of liquid reaches the bladder",
    editProfileLabel: "Edit profile",
    realismFeedback: "Realism: {absorbed} ml absorbed from {drank} ml drunk.",
    status: {
  ...
  ru: {
    ...
    realismLabel: "Режим реализма",
    realismNote: "Только 50-70% выпитого попадает в мочевой пузырь",
    editProfileLabel: "Изменить профиль",
    realismFeedback: "Реализм: {absorbed} мл впиталось из {drank} мл выпитых.",
    status: {
  ...
  de: {
    ...
    realismLabel: "Realismus-Modus",
    realismNote: "Nur 50-70% der Flüssigkeit erreichen die Blase",
    editProfileLabel: "Profil bearbeiten",
    realismFeedback: "Realismus: {absorbed} ml absorbiert von {drank} ml getrunken.",
    status: {
  ...
  fr: {
    ...
    realismLabel: "Mode réaliste",
    realismNote: "Seulement 50-70% du liquide atteint la vessie",
    editProfileLabel: "Modifier le profil",
    realismFeedback: "Réalisme: {absorbed} ml absorbés sur {drank} ml bus.",
    status: {
  ...
  es: {
    ...
    realismLabel: "Modo realismo",
    realismNote: "Solo el 50-70% del líquido llega a la vejiga",
    editProfileLabel: "Editar perfil",
    realismFeedback: "Realismo: {absorbed} ml absorbidos de {drank} ml bebidos.",
    status: {
  ...
  it: {
    ...
    realismLabel: "Modalità realismo",
    realismNote: "Solo il 50-70% del liquido raggiunge la vescica",
    editProfileLabel: "Modifica profilo",
    realismFeedback: "Realismo: {absorbed} ml assorbiti da {drank} ml bevuti.",
    status: {
  ...
  zh: {
    ...
    realismLabel: "现实主义模式",
    realismNote: "只有50-70%的液体进入膀胱",
    editProfileLabel: "编辑个人资料",
    realismFeedback: "现实主义: {absorbed} 毫升被吸收，共喝了 {drank} 毫升。",
    status: {
      critical: "严重过满！忍不住了！",
      overflow: "过满！立刻找厕所！",
  ...
  ja: {
    ...
    realismLabel: "リアリズムモード",
    realismNote: "液体の50-70%だけが膀胱に到達します",
    editProfileLabel: "プロフィール編集",
    realismFeedback: "リアリズム: {drank} ml飲んで {absorbed} ml吸収されました。",
    status: {
  ...
  ko: {
    ...
    realismLabel: "리얼리즘 모드",
    realismNote: "액체의 50-70%만 방광에 도달합니다",
    editProfileLabel: "프로필 수정",
    realismFeedback: "리얼리즘: {drank} ml 마셔서 {absorbed} ml 흡수됨.",
    status: {
  ...
  tr: {
    ...
    updateBtn: "Değişiklikleri kaydet",
    ...
    realismLabel: "Gerçekçilik modu",
    realismNote: "Sıvının sadece %50-70'i mesaneye ulaşır",
    editProfileLabel: "Profili düzenle",
    realismFeedback: "Gerçekçilik: {drank} ml içildi, {absorbed} ml emildi.",
    status: {
